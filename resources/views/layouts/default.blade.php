...
<head>
    ...
    <title>HT Food | @yield('title', 'Trang chủ')</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('https://scontent.fdad1-4.fna.fbcdn.net/v/t1.15752-9/363863549_3180112462281786_1771883133554489869_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=ae9488&_nc_ohc=-YXw-GzyDKQAX8tXNMC&_nc_ht=scontent.fdad1-4.fna&oh=03_AdT9Gl5pRqpCNTzcYyTJRZTPYYPFB6ZOykiqGf9ItrSE8Q&oe=65282C36') }}"
