  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ route('menu.index') }}" class="brand-link">
          <img src="{{ asset('https://scontent.fdad1-4.fna.fbcdn.net/v/t1.15752-9/363863549_3180112462281786_1771883133554489869_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=ae9488&_nc_ohc=-YXw-GzyDKQAX8tXNMC&_nc_ht=scontent.fdad1-4.fna&oh=03_AdT9Gl5pRqpCNTzcYyTJRZTPYYPFB6ZOykiqGf9ItrSE8Q&oe=65282C36') }}" alt="AdminLTE Logo"
              class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light">HT Food</span>
      </a>
